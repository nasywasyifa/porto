                ...
                <div class="content-wrapper">
                    ...
                    <div class="container-xxl flex-grow-1 container-p-y">
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card">
                                    <div class="card-header">Data pengalaman</div>
                                    <div class="card-body">
                                        ...
                                        <div align="right" class="mb-3">
                                            <a href="tambah_pengalaman.php" class="btn btn-primary">Tambah</a>
                                        </div>
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                while ($rowPengalaman = mysqli_fetch_assoc($queryPengalaman)) { ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td><?php echo $rowPengalaman['nama_perusahaan'] ?></td>
                                                        <td><?php echo $rowPengalaman['deksripsi_pengalaman'] ?></td>
                                                        <td><?php echo $rowPengalaman['jabatan'] ?></td>
                                                        <td><?php echo $rowPengalaman['deskripsi_jabatan'] ?></td>

                                                        <td>
                                                            <a href="tambah_pengalaman.php?edit=<?php echo $rowPengalaman['id'] ?>" class="btn btn-success btn-sm">
                                                                <span class="tf-icon bx bx-pencil bx-18px"></span></a>

                                                            <a onclick="return confirm('Apakah anda yakin akan menghapus data ini?')"
                                                                href="pengalaman.php?delete=<?php echo $rowPengalaman['id'] ?>" class="btn btn-danger btn-sm">
