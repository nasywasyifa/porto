...
if (isset($_GET['delete'])) {
    ...
    header("location:konten.php?hapus=berhasil");
}
?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div align="right" class="mb-3">
                                            <a href="tambah-konten.php" class="btn btn-primary">Tambah</a>
                                        </div>
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                <?php $no = 1;
                                                while ($row = mysqli_fetch_assoc($queryKonten)) { ?>
                                                    <tr>
                                                        <td><?php echo $no++ ?></td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="tambah-konten.php?edit=<?php echo $row['id'] ?>" class="btn btn-success btn-sm">
                                                                <span class="tf-icon bx bx-pencil bx-18px "></span>
                                                            </a>
                                                            <a onclick="return confirm('Apakah anda yakin akan menghapus data ini??')"
                                                                href="konten.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">
