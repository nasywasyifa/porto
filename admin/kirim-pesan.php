...
if (isset($_GET['pesanId'])) {
    $id = intval($_GET['pesanId']); // Menggunakan intval untuk menghindari injeksi SQL
...
if (isset($_POST['kirim-bosss']) && isset($_GET['pesanId'])) {
    $id = $_GET['pesanId']; // Pastikan ID adalah integer
    $email = filter_var($_POST['email'], FILTER_SANITIZE_EMAIL); // Sanitasi email
    $subject = htmlspecialchars($_POST['subject']); // Menghindari XSS
    $balaspesan = htmlspecialchars($_POST['balaspesan']); // Menghindari XSS

    $headers = "From: nasywahanifahnasy@gmail.com" . "\r\n" .
        "Reply-To: nasywahanifahnasy@gmail.com" . "\r\n" .
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <ul style="list-style-type: '-'">
                                            <li>
                                                <pre>Name : <?php echo $rowContact['name'] ?></pre>
                                            </li>
                                            <li>
                                    ...
                                    <div class="mt-3">
                                        ...
                                        <textarea class="form-control" name="balaspesan" cols="30" rows="10" required id=""></textarea>
                                    </div>
                                    <div class="mt-3">
