                                        ...
                                        <form action="" method="post" enctype="multipart/form-data">
                                            <div class="mb-3 row">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control" name="nama_instruktur" placeholder="Masukan nama anda"
                                                        required
                                                        value="<?php echo isset($_GET['edit']) ? $rowEdit['nama_instruktur'] : '' ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label for="" class="form-label">Jurusan</label>
                                                    <input type="text" class="form-control" name="jurusan_instruktur" placeholder="Masukan jurusan anda"
                                                        required
