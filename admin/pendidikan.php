...
//mysqli_fetch_assoc($query) = untuk menjadikan hasil query menjadi sebuah data (objek,array)
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div align="right" class="mb-3">
                                            <a href="tambah_pendidikan.php" class="btn btn-primary">Tambah</a>
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                while ($row = mysqli_fetch_assoc($query)) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="tambah_pendidikan.php?edit=<?php echo $row['id'] ?>" class="btn btn-success btn-sm">
                                                                <span class="tf-icon bx bx-pencil "></span>
                                                            </a>
                                                            <a onclick="return confirm('apakah anda yakin ?')" href="pendidikan.php?delete=<?php echo $row['id'] ?>" class="btn btn-danger btn-sm">
